...
resource "aws_ssm_parameter" "ansible_sg_id" {
  name  = "/${var.project_name}/${var.environment}/ansible_sg_id" #/expense/dev/bastion_sg_id
  type  = "String"
...
resource "aws_ssm_parameter" "web_alb_sg_id" {
  name  = "/${var.project_name}/${var.environment}/web_alb_sg_id" #/expense/dev/app_alb_sg_id
  type  = "String"
